...
export class HousesController extends BaseController {
    ...
    async getHouses(req, res, next) {
        try {
            const houses = await housesServices.getHouses()
    ...
    async getHouseById(req, res, next) {
        try {
            ...
            const house = await housesServices.getHouseById(houseId)
    ...
    async createHouse(req, res, next) {
        try {
            ...
            const house = await housesServices.createHouse(houseData)
    ...
    async removeHouse(req, res, next) {
        try {
            ...
            await housesServices.removeHouse(houseId, userId)
    ...
    async editHouse(req, res, next) {
        try {
            ...
            const userId = req.userInfo.id
            const houseData = req.body
            const updatedHouse = await housesServices.editHouse(houseId, userId, houseData)
